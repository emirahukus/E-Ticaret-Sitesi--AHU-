...
import ReactQuill from "react-quill"; //zengin metin editörü olarak kullanılır ve stili ile birlikte ithal edilir.
...
const CreateProductPage = () => {
    ...
    //onFinish, form gönderildiğinde çağrılır.
    //Ürün görselleri, renkler ve bedenler satırlara göre ayrılır ve düzenlenir.
    //API'ye bir POST isteği gönderilir ve form verileri JSON formatında iletilir.
    ...
    return (
        <Spin spinning={loading}>
            <Form name="basic" layout="vertical" onFinish={onFinish} form={form}>
                ...
                >
                    <Input.TextArea
                        placeholder="Her bir Hex kodunu yeni bir satıra yazın."
                        autoSize={{ minRows: 4 }}
                    />
                </Form.Item>
                <Form.Item
